...
<body>
	...
	<!-- form sign up -->
<<<<<<< HEAD:target/BookStore/sachThieuNhi.html
...
>>>>>>> beb6171e031060683c3e3cdf6db133bf9756d9e2:target/BookStore/sachThieuNhi.jsp
			<!-- /NAVIGATION -->
					...
					<div class="row">
						<div class="col-md-12">
							<ul class="breadcrumb-tree">
								<h3 class="breadcrumb-header">Sách thiếu nhi</h3>
								<li><a href="index.jsp">Trang chủ</a></li>
								<li class="active">Sách thiếu nhi</li>
							</ul>
						</div>
					</div>
					<!-- /row -->
