								...
								<div class="products-slick" data-nav="#slick-nav-1">
									...
									<div class="product">
										<div class="product-img">
											<a href="product.jsp"><img src="./img/index/Moi/10-huyen-thoai-viking-hay-nhat-moi-thoi-dai.jpg"
										...
										<div class="add-to-cart">
											<a href="cart.jsp"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> thêm vào
												giỏ</button></a>
										</div>
									</div>
									<!-- /product -->
									...
									<div class="product">
										<div class="product-img">
											<a href="product.jsp"><img src="./img/index/Moi/100-mau-chuyen-co-dong-tay-nguyen-lan.jpg"
									...
									<div class="product">
										<div class="product-img">
											<a href="product.jsp"><img src="./img/index/Moi/108-truyen-ngu-ngon-hay-nhat.jpg"
										...
										<div class="product-body">
											...
											<h4 class="product-price">55,000₫ <del
													class="product-old-price">110,000₫</del></h4>
											<div class="product-rating">
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
									...
									<div class="product">
										<div class="product-img">
											<a href="product.jsp"><img src="./img/index/Moi/365-chuyen-ke-hang-dem-mua-thu.jpg"
									...
									<div class="product">
										<div class="product-img">
											<a href="product.jsp"><img src="./img/index/Moi/buratino-va-chiec-chia-khoa-vang.jpg"
								...
								<div class="products-slick" data-nav="#slick-nav-2">
									...
									<div class="product">
										...
										<div class="product-body">
											...
											<h4 class="product-price">90,000₫ <del
													class="product-old-price">129,000₫</del></h4>
											<div class="product-rating">
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
						...
						<div>
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h4 class="product-price">50,000₫ <del class="product-old-price">90,000₫</del></h4>
								</div>
							</div>
							<!-- /product widget -->
						...
						<div>
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h4 class="product-price">80,000₫ <del class="product-old-price">100,000₫</del></h4>
								</div>
							</div>
							<!-- product widget -->
						...
						<div>
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h4 class="product-price">50,000₫ <del class="product-old-price">80,000₫</del></h4>
								</div>
							</div>
							<!-- /product widget -->
