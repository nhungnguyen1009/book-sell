...
<head>
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <link rel="stylesheet" href="assets/vendor/fonts/fontawesome/css/fontawesome-agll.css">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-0" aria-controls="submenu-0"><i class="fas fa-fw fa-chart-pie"></i>Tài khoản</a>
