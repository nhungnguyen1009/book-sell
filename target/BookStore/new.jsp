...
<body>
	...
	<!-- form sign up -->
<<<<<<< HEAD:target/BookStore/new.html
				...
				<div class="container">
					...
					<div id="responsive-nav">
						...
						<ul class="main-nav nav navbar-nav">
							...
							<li class="active"><a href="new.html">Mới</a></li>
...
>>>>>>> beb6171e031060683c3e3cdf6db133bf9756d9e2:target/BookStore/new.jsp
			<!-- /NAVIGATION -->
					...
					<div class="row">
						<div class="col-md-12">
							<ul class="breadcrumb-tree">
								<h3 class="breadcrumb-header">Mới</h3>
								<li><a href="index.jsp">Trang chủ</a></li>
								<li class="active"><a href="#">Mới</a></li>
							</ul>
						</div>
					</div>
					<!-- /row -->
