...
<body>
	...
	<!-- form sign up -->
<<<<<<< HEAD:src/main/webapp/kinhte.html
...
>>>>>>> beb6171e031060683c3e3cdf6db133bf9756d9e2:target/BookStore/kinhte.jsp
			<!-- /NAVIGATION -->
					...
					<div class="row">
						<div class="col-md-12">
							<ul class="breadcrumb-tree">
								<h3 class="breadcrumb-header">Kinh tế</h3>
								<li><a href="index.jsp">Trang chủ</a></li>
								<li class="active">Kinh tế</li>
							</ul>
						</div>
					</div>
					<!-- /row -->
