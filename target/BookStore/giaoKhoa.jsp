...
<body>
	...
	<!-- form sign up -->
<<<<<<< HEAD:src/main/webapp/giaoKhoa.html
...
>>>>>>> beb6171e031060683c3e3cdf6db133bf9756d9e2:target/BookStore/giaoKhoa.jsp
			<!-- /NAVIGATION -->
					...
					<div class="row">
						<div class="col-md-12">
							<ul class="breadcrumb-tree">
								<h3 class="breadcrumb-header">Giáo khoa - Tham khảo</h3>
								<li><a href="index.jsp">Trang chủ</a></li>
								<li class="active">Giáo khoa - Tham khảo</li>
							</ul>
						</div>
					</div>
					<!-- /row -->
