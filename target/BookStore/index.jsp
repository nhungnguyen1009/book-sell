			...
			<div class="modal-body">
				<form action="/login">
					...
					<div class="form-group">
						...
						<small id="emailHelp" class="form-text text-muted">Bạn đừng để ai nhìn thấy mật khẩu nhé!</small>
					</div>
					<div class="form-group">
					...
					<div class="form-group form-check" style="float: right;">
						<button onclick="document.getElementById('id01').style.display='none'" ><a href="#" data-toggle ="modal" data-target="#exampleModal">Đăng nhập</a></button>
					</div>
			...
			<div class="modal-body">
				<form action="<%=Utils.fullPath("login")%>">
					<div class="form-group" id = "example1">
						...
						<input type="email" name="email" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Tên đăng nhập hoặc email">
					...
					<div class="form-group form-check">
						...
						<div style="text-align: center;">
							<button type="submit" class="btn btn-primary" style="width: 50%; height: 50px; border-radius: 25px; outline: 0px;">Đăng nhập</button><br>
						</div>
						<div style="margin-bottom:-10px; margin-top: 15px; text-align: center;">
							Bạn chưa có tài khoản?
						<button onclick="document.getElementById('id01').style.display='block'"><a href="#" data-toggle ="modal" data-target="#exampleModal">Đăng ký</a></button>
						</div>
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="#`"><i class="fa fa-envelope-o"></i> japanbanana@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> Quận Thủ Đức, TPHCM</a></li>
					</ul>
					<ul class="header-links pull-right">
						<li><a href="#" data-toggle ="modal" data-target="#id01"><i class="fa fa-user-o"></i> Đăng ký</a></li>
						<li><a href="#" data-toggle ="modal"
						data-target="#exampleModal"><i class="fa fa-user-o"></i> Đăng nhập</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							...
							<form>
								<input class="input" type="email" placeholder="Enter Your Email" style="width: 250px;">
