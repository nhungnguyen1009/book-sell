...
<body>
    ...
    <!-- form sign up -->
<<<<<<< HEAD:target/BookStore/discount.html
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" id="exampleInputFullname1" aria-describedby="nameHelp" placeholder="Họ và tên">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" id="exampleInputFullname" aria-describedby="nameHelp" placeholder="Tên đăng nhập">
                        </div>
                        <div class="form-group">
                        ...
                        <div style="text-align: center;">
                            <button type="submit" class="btn btn-primary" style="width: 50%; height: 50px; border-radius: 25px; outline: 0px;">Gửi</button><br>
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group" id="example1">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Tên đăng nhập hoặc email">
                        ...
                        <div class="form-group form-check">
                            ...
                            <div style="text-align: center;">
                                <button type="submit" class="btn btn-primary" style="width: 50%; height: 50px; border-radius: 25px; outline: 0px;">Đăng
									nhập</button><br>
                            </div>
                ...
                <div class="container">
                    ...
                    <div id="responsive-nav">
                        ...
                        <ul class="main-nav nav navbar-nav">
                            ...
                            <li class="active"><a href="discount.html">Khuyến mãi</a></li>
...
>>>>>>> beb6171e031060683c3e3cdf6db133bf9756d9e2:target/BookStore/discount.jsp
            <!-- /NAVIGATION -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb-tree">
                                <h3 class="breadcrub-header">Sản phẩm khuyến mãi</h3>
                        ...
                        <div id="store" class="col-md-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="./img/discount/72-thuat-tan-cong-tam-ly-trong-ban-le.jpg" alt="Thuật tấn công tâm lý trong bán lẻ">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Kinh tế</p>
                                            <h3 class="product-name"><a href="#">Thuật tấn công tâm lý trong bán lẻ</a></h3>
                                            <h4 class="product-price">100,000₫</h4>
                                ...
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="./img/discount/ban-hang-thong-minh-qua-dien-thoai-va-internet.jpg" alt="Bán hàng thông minh qua điện thoại và internet">
                                        ...
                                        <div class="product-body">
                                            <p class="product-category">Kinh tế</p>
                                            <h3 class="product-name"><a href="#">Bán hàng thông minh qua điện thoại và internet</a></h3>
                                ...
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="./img/discount/bi-mat-hanh-trinh-tinh-yeu.jpg" alt="Bí mật hành trình tình yêu">
                                            <div class="product-label">
                                                <span class="new">MỚI</span>
                                            </div>
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Văn học</p>
                                            <h3 class="product-name"><a href="#">Bí mật hành trình tình yêu</a></h3>
                                ...
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="./img/discount/bien-bat-ky-ai-thanh-khach-hang.jpg" alt="Biến bất kỳ ai thành khách hàng">
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                                <span class="new">MỚI</span>
                                            </div>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-btns">
                                                ...
                                                <button class="quick-view"><a href="javascript:void(0);"
														class="quickview" data-handle="quickview"
														style="color: black;"><i class="fa fa-eye"></a></i><span class="tooltipp">xem nhanh</span></button>
                                        </div>
                                    </div>
                                    <div class="add-to-cart">
                                        <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> thêm vào
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="./img/discount/Chien-thang-con-quy-ben-trong-ban.gif" alt="Chiến thắng con quỷ bên trong bạn">
                                        <div class="product-label">
                                            <span class="sale">-30%</span>
                                            <span class="new">MỚI</span>
                                        </div>
                                    ...
                                    <div class="product-body">
                                        <p class="product-category">Văn học</p>
                                        <h3 class="product-name"><a href="#">Chiến thắng con quỷ bên trong bạn</a></h3>
                                        <h4 class="product-price">210,000₫ <del class="product-old-price">300,000₫</del></h4>
                                        <div class="product-rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="./img/discount/dam-bi-ghet.jpg" alt="Truyện Buratino và chiếc chìa khóa vàng">
                                        <div class="product-label">
                                            <span class="sale">-30%</span>
                                            <span class="new">MỚI</span>
                                        </div>
                                    ...
                                    <div class="product-body">
                                        <p class="product-category">Giáo dục</p>
                                        <h3 class="product-name"><a href="#">Dám bị ghét</a></h3>
                                        <h4 class="product-price">140,000₫ <del class="product-old-price">200,000₫</del></h4>
                                        <div class="product-rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="./img/discount/danh-thuc-nang-luc-vo-han.jpg" alt="Đánh thức năng lực vô hạn">
                                        <div class="product-label">
                                            <span class="sale">-30%</span>
                                            <span class="new">MỚI</span>
                                        </div>
                                    ...
                                    <div class="product-body">
                                        <p class="product-category">Văn học</p>
                                        <h3 class="product-name"><a href="#">Đánh thức năng lực vô hạn</a></h3>
                                        <h4 class="product-price">115,000₫ <del class="product-old-price">150,000₫</del></h4>
                                        <div class="product-rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="./img/discount/giaoducconcuanguoiMy.jpg" alt="Giáo dục con của người Mỹ">
                                        <div class="product-label">
                                            <span class="sale">-30%</span>
                                    ...
                                    <div class="product-body">
                                        <p class="product-category">Giáo dục</p>
                                        <h3 class="product-name"><a href="#">Giáo dục con của người Mỹ</a></h3>
                                        <h4 class="product-price">115,000₫ <del class="product-old-price">150,000₫</del></h4>
                                        <div class="product-rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
