...
<body>
    ...
    <!-- form sign up -->
<<<<<<< HEAD:src/main/webapp/sachNgoaiNgu.html
...
>>>>>>> beb6171e031060683c3e3cdf6db133bf9756d9e2:target/BookStore/sachNgoaiNgu.jsp
			<!-- /NAVIGATION -->
					...
					<div class="row">
						<div class="col-md-12">
							<ul class="breadcrumb-tree">
								<h3 class="breadcrumb-header">Sách học ngoại ngữ</h3>
								<li><a href="index.jsp">Trang chủ</a></li>
								<li class="active">Sách học ngoại ngữ</li>
							</ul>
						</div>
					</div>
					<!-- /row -->
                                ...
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h4 class="product-price">115,000₫ <de class="product-old-price">150,000₫</del></h4>
                                            <div class="product-rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
