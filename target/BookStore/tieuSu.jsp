...
<body>
    ...
    <!-- form sign up -->
<<<<<<< HEAD:src/main/webapp/tieuSu.html
                                    ...
                                    <div class="cart-list">
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="./img/10-huyen-thoai-viking-hay-nhat-moi-thoi-dai.jpg" alt="">
                                            </div>
                                        ...
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="./img/discount/ban-hang-thong-minh-qua-dien-thoai-va-internet.jpg" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="#">Bán hàng</a></h3>
...
>>>>>>> beb6171e031060683c3e3cdf6db133bf9756d9e2:target/BookStore/tieuSu.jsp
            <!-- /NAVIGATION -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb-tree">
                                <h3 class="breadcrumb-header">Tiểu sử - Hồi ký</h3>
                                <li><a href="index.jsp">Trang chủ</a></li>
                                <li class="active">Tiểu sử - Hồi ký</li>
                            </ul>
                        </div>
                    </div>
                    <!-- /row -->
